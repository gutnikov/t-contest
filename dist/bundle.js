...
var ChartCanvas = function () {
    ...
    _createClass(ChartCanvas, [{
        ...
        value: function handleYRangeChanged() {
            var t = this.timing('changeHeight', timing(600, null, 100));
        ...
        value: function renderTooltip() {
            ...
            var rectX = points[anyLine].p.x > this.width * getDpr() / 2 ? points[anyLine].p.x - rectWidth - 30 * getDpr() : points[anyLine].p.x + 30 * getDpr();
            var rectY = 10;
            var r = 40;
